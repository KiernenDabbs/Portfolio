          ...
          <CardContent className="space-y-6">
            <div className="space-y-2">
              ...
              <ul className="list-disc list-inside text-muted-foreground space-y-1">
                <li>
                  Led development of key features resulting in 40% increase in
                  user engagement
                </li>
                <li>
                  Architected and implemented scalable solutions handling
            ...
            <div className="space-y-2">
              ...
              <ul className="list-disc list-inside text-muted-foreground space-y-1">
                <li>
                  Developed and maintained full-stack applications using modern
                  technologies
                </li>
                <li>
